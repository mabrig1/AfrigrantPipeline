...
const KEY_HASH = '2a8aed2bbd8992fa299de2fab16fa25ca946cbcb9846b200eb072a320a4fd8a5'
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const owner = await User.findOne({ email: 'mabrig1@gmail.com' })
