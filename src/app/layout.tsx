...
export const metadata: Metadata = {
  ...
  description:
    ...
    'Connecting students, researchers, universities, NGOs, industries, ' +
    'and funding organizations across the continent.',
  keywords: [
    'Africa grants',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AfrigrantPipeline – Africa's Research & Innovation Infrastructure',
      },
    ],
  },
  twitter: {
...
// ── Viewport (theme colour for mobile browsers) ────────────────────────────
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    // browser extensions inject attributes onto <html>.
